...
`);
const LogoTextWrapper = (0, styles_1.styled)(material_1.Box)(({ theme }) => `
        padding-left: ${theme.spacing(1)};
`);
const VersionBadge = (0, styles_1.styled)(material_1.Box)(({ theme }) => `
...
`);
const LogoText = (0, styles_1.styled)(material_1.Box)(({ theme }) => `
        font-size: ${theme.typography.pxToRem(15)};
        font-weight: ${theme.typography.fontWeightBold};
`);
function Logo() {
    return (<LogoWrapper to="/overview">
      <LogoSignWrapper>
        <LogoSign>
          <LogoSignInner />
        </LogoSign>
      ...
      <material_1.Hidden smDown>
        <LogoTextWrapper>
          <material_1.Tooltip title="Version 1.1.0" arrow placement="right">
